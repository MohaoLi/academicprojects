...
//    private static final String FILENAME = ".\\DataBank(part1).db4o"; // path to the data store
    private static final String FILENAME = ".\\DataBank(part2).db4o"; // path to the data store
